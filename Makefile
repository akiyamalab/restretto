...
_EASYTEST_OBJS = easytest_main.o Vector3d.o Molecule.o EnergyGrid.o EnergyCalculator.o infile_reader.o utils.o Atom.o log_writer_stream.o log_writer.o OBMol.o
...
ALL = atomgrid-gen gradientgrid-gen conformer-docking #atom-docking unittest easytest-docking score-only intraenergy-only
