  ...
  */
  ...
  public:
    ...
    */
    ...
    /**
     * repulsion term of AutoDock Vina
     * @param t1 type of atom 1
     * @param t2 type of atom 2
     * @param d surface distance between atom 1 and atom 2
    */
    ...
    /**
     * hydrophobic term of AutoDock Vina
     * @param t1 type of atom 1
     * @param t2 type of atom 2
     * @param d surface distance between atom 1 and atom 2
    */
    ...
    /**
     * Hydrogen bonding term of AutoDock Vina
     * @param t1 type of atom 1
     * @param t2 type of atom 2
     * @param d surface distance between atom 1 and atom 2
    */
    static fltype Hydrogen(int t1, int t2, fltype d);
